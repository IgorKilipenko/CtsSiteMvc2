...
namespace CtsSiteMvc2
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private async Task configSendGridasync(IdentityMessage message)
        {
            ...
            var user = "igorkilip@gmail.com";
            //var pass = "Wfllvby1285";
            var host = "smtp.gmail.com";

            string to = message.Destination;
            string from = user;
            var fromAddress = new MailAddress(from, "noreply(КранТехСервис)");
            var toAddress = new MailAddress(to);
            const string fromPassword = "Wfllvby1285";
            ...
            using (var mailMsg = new MailMessage(fromAddress, toAddress) { Subject = message.Subject})
            {
            ...
            try
            {
                ...
                // From
                mailMsg.From = new MailAddress(user, "noreply(КранТехСервис)");
